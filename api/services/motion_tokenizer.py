...
class MotionTokenizer:
    ...
    def tokenize(self, text: str) -> list[dict]:
        ...
        for seg in segments:
            ...
            # [FIX] "합니다", "하다" 등 보조용언/어미가 띄어쓰기 되어 단독으로 들어올 경우,
            # 내부에서 "다" (전부) 등이 오매칭되어 불필요하게 재생되는 것을 방지합니다.
            _IGNORE_ALONE = {
                "합니다", "합니까", "입니다", "입니까", "습니다", "습니까", "ㅂ니다", "ㅂ니까",
                "해요", "이에요", "예요", "어요", "아요", "해",
                "하다", "되다", "이다", "하고", "하면", "해서", "하여", "하게", "하는", "할",
                "했습니다", "했어요", "했어", "했다", "하셨습니다", "하셨어요", "하셨다",
                "이었습니다", "였습니다", "이었어", "였어", "이었다", "였다",
                "겠습니다", "겠어요", "겠어", "겠다", "잖아요", "잖아", "지요", "죠"
            }
            if seg_norm in _IGNORE_ALONE:
                tokens.append({"word": seg, "source": "unknown", "canonical": None})
                continue
